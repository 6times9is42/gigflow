...
const variantClasses: Record<StatusVariant | GenericVariant, string> = {
  // Lead status
  New: 'bg-blue-500/12 text-blue-400 border-blue-500/25 dark:bg-blue-500/12 dark:text-blue-400 dark:border-blue-500/25 bg-blue-50 text-blue-600 border-blue-200',
  Contacted: 'bg-amber-500/12 text-amber-500 border-amber-500/25 dark:bg-amber-500/12 dark:text-amber-400 dark:border-amber-500/25 bg-amber-50 text-amber-600 border-amber-200',
  Qualified: 'bg-emerald-500/12 text-emerald-400 border-emerald-500/25 dark:bg-emerald-500/12 dark:text-emerald-400 dark:border-emerald-500/25 bg-emerald-50 text-emerald-600 border-emerald-200',
  Lost: 'bg-red-500/12 text-red-400 border-red-500/25 dark:bg-red-500/12 dark:text-red-400 dark:border-red-500/25 bg-red-50 text-red-600 border-red-200',
  // Generic
